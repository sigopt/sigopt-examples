...
Use SigOpt's [Java API Client](https://docs.sigopt.com/core-module-api-references/get_started) to tune the [Franke function](http://www.sfu.ca/~ssurjano/franke2d.html)
