    ...
    def train_model(self, training_data, validation_data, number_of_labels):
        ...
        for epoch in range(self.epochs):  # loop over the dataset multiple times
            ...
            for i, data in enumerate(training_data):
                inputs = data[AStanfordCarDataset.TRANSFORMED_IMAGE]
                labels = data[AStanfordCarDataset.LABEL]
            ...
            if epoch % self.validation_frequency == 0 or epoch == self.epochs-1:
                ...
                for i, data in enumerate(validation_data):
                    validation_input = data[AStanfordCarDataset.TRANSFORMED_IMAGE]
                    validation_input = validation_input.to(device)
                    validation_labels = data[AStanfordCarDataset.LABEL]
