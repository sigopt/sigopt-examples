...
if experiment_id is None:
    ...
    if with_architecture:
        exp_name = 'Multicriteria GPU-powered Sentiment Analysis (SGD + Architecture)'
        param_filepath = 'cnn_text/long_hyperparams.json'
    else:
        exp_name = 'Multicriteria GPU-powered Sentiment Analysis (SGD Only)'
...
def create_observation_dict(suggestion):
    ...
    return {
        ...
        'values': [
            ...
            {'name': 'train_time', 'value': end - start},
        ],
    }
