...
tf.flags.DEFINE_string("log_file", "memn2n_optimization_run.log", "file path. Default will output file: memn2n_optimization_run.log in working directory")
...
tf.flags.DEFINE_string("sigopt_calc_accuracy_tasks", "5,17,19", "Tasks used to measure optimizaiton progress in increasing order. Default 5, 17, 19.")
...
tf.flags.DEFINE_string("data_dir", "data/tasks_1-20_v1-2/en/", "Directory containing bAbI tasks. Default data/tasks_1-20_v1-2/en/")
...
assert (FLAGS.run_single_exp is True and FLAGS.run_joint_exp is False) or (FLAGS.run_joint_exp is True and FLAGS.run_single_exp is False)
